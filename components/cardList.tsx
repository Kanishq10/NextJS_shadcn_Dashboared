        ...
        <div>
            ...
            <div className="flex flex-col gap-2">
                {list.map((item) => (
                    <Card
                        key={item.id}
                        className="flex flex-row items-center justify-around gap-4 px-3 py-2"
                    >
                        {/* Image (centered inside 12x12 box) */}
                        ...
                        {/* Footer (centered count) */}
                        <CardFooter className="text-sm font-semibold justify-center p-0">
                            {item.count / 1000}K
                        </CardFooter>
                    </Card>
                ))}
